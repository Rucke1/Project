# Project: UHD Student Resource Hub
Team Members: Brandon Aguilar, Karla Martinez, Nora Ortiz, Eric Ruck
...
•	JavaScript Implementation: This page has a JavaScript-based Get Started button that can give user feedback and redirect timed to the contact page.
...
•	Action: Form data is processed via http://www.randyconnolly.com/tests/process.php.4. 
